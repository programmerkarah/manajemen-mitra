...
Route::view('/panduan', 'panduan.simantik-petunjuk-penggunaan')
    ->withoutMiddleware([
...
Route::middleware(['auth', 'verified', 'sso.organization', 'require.2fa'])->group(function () {
    ...
    Route::middleware(['active.role:admin,operator,pj,approver,ketua_tim'])->group(function () {
        ...
        Route::get('spk/month/kegiatan/{kegiatan}/download', [SpkController::class, 'downloadByKegiatanMonth'])->name('spk.download-by-kegiatan-month');
    ...
    Route::middleware(['active.role:admin,approver'])->group(function () {
        ...
        Route::post('spk/{spkHashedId}/regenerate-document', [SpkController::class, 'regenerateDocument'])->name('spk.regenerate-document');
