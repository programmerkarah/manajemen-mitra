                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => handleJenisPetugasChange(e.target.value)}
                                        required
                                        className="h-10 w-full rounded-lg border border-neutral-300 px-3 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100"
                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    {jenisPetugas === 'non-organik' && (
                                        <p className="text-xs text-muted-foreground">Jabatan untuk non-organik otomatis: Mitra Statistik</p>
                                    )}
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {jenisPetugas === 'non-organik' && (
                                        <p className="text-xs text-muted-foreground">Golongan untuk non-organik otomatis: Non PNS</p>
                                    )}
