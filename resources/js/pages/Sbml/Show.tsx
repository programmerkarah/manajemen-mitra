                ...
                <ContentCard>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div className="space-y-1">
                            ...
                            <p className="text-lg font-semibold">{tahun}</p>
                        </div>
                ...
                <ContentCard padding="none">
                    <div className="border-b border-neutral-200/70 px-6 py-4 dark:border-neutral-800">
                        ...
                        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            Daftar lengkap honor maksimal berdasarkan jenis
                            kegiatan, status kepegawaian, dan jenis penugasan
                        </p>
                    </div>
                                ...
                                {sbmlEntries.map((entry, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="inline-flex rounded-full bg-blue-100 px-2 py-1 text-xs font-semibold text-blue-800 dark:bg-neutral-700/60 dark:text-blue-300">
                                        ...
                                        <td className="px-6 py-4 text-right text-sm font-semibold whitespace-nowrap text-gray-900 dark:text-white">
