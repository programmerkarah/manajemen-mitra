...
export default function Create({
    ...
    const [jenis, setJenis] = useState<'pertama' | 'perubahan'>('pertama');
    ...
    const [nomorLn, setNomorLn] = useState('');
    const [tahunLn, setTahunLn] = useState('');
    const [nomorTln, setNomorTln] = useState('');
    const [nomorBn, setNomorBn] = useState('');
    const [tahunBn, setTahunBn] = useState('');

    const [indukId, setIndukId] = useState<number | null>(null);
                                ...
                                {jenis === 'perubahan' && (
                                    <div className="space-y-3 rounded-lg border border-amber-200 bg-amber-50/60 p-4 dark:border-amber-800 dark:bg-amber-900/10">
                                        ...
                                        <p className="text-xs text-amber-700/90 dark:text-amber-300/80">
                                            Pilih regulasi induk yang akan
                                            menjadi dasar narasi perubahan di
                                            preview SK.
                                        </p>
