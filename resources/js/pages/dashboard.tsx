            ...
            <div className="flex flex-1 flex-col gap-6">
                ...
                <div className="rounded-xl border border-neutral-200/50 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 shadow-sm dark:border-neutral-800 dark:from-blue-950/30 dark:to-indigo-950/30">
                    ...
                    <p className="mt-2 text-neutral-600 dark:text-neutral-400">
                        Sistem Manajemen Mitra - Kelola data petugas, kegiatan,
                        dan alokasi dengan mudah
                    </p>
                </div>
                            ...
                            <div className="space-y-4">
                                {recentAlokasi.length > 0 ? (
                                    recentAlokasi.map((alokasi) => (
                                        <div
                                            key={alokasi.id}
                                            className="flex items-start justify-between rounded-lg border border-neutral-200 p-4 transition-all hover:border-neutral-300 dark:border-neutral-800 dark:hover:border-neutral-700"
                                        >
