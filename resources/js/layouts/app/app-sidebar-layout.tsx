...
export default function AppSidebarLayout({
    ...
    return (
        <AppShell variant="sidebar">
            <div className="flex h-screen w-full overflow-x-hidden bg-gradient-to-br from-blue-50/50 via-white/30 to-indigo-50/50 dark:from-neutral-950/50 dark:via-neutral-900/30 dark:to-neutral-950/50 backdrop-blur-sm">
                {/* Sidebar */}
                <AppSidebar />
                ...
                <div className="flex flex-1 flex-col min-w-0 h-full">
                    ...
                    <AppContent variant="sidebar" className="overflow-y-auto overflow-x-auto flex-1 min-h-0">
                        <div className="flex flex-col gap-4 p-4 md:gap-6 md:p-6 pb-8 md:pb-12 min-w-0 w-full">
                            {children}
                        </div>
                    </AppContent>
                    <FlashMessage />
