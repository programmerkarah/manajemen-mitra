...
export default function AppSidebarLayout({
    ...
    return (
        <AppShell variant="sidebar">
            <div className="flex h-screen w-full overflow-x-hidden bg-gradient-to-br from-blue-50/50 via-white/30 to-indigo-50/50 dark:from-neutral-950/50 dark:via-neutral-900/30 dark:to-neutral-950/50">
                {/* Sidebar */}
                <AppSidebar />
