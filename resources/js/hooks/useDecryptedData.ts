 ...
 */
export function useDecryptedData<T = any>(encryptedData: string | null | undefined): T[] {
    return useMemo(() => {
 ...
 */
export function useDecryptedObject<T = any>(encryptedData: string | null | undefined): T | null {
    return useMemo(() => {
