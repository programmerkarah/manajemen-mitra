...
export function SearchableSelect({
    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            {/* Dropdown */}
            {open && (
                <div className="absolute z-50 mt-1 w-full rounded-xl border border-white/20 bg-white/95 shadow-2xl backdrop-blur-xl dark:border-neutral-700/30 dark:bg-neutral-800/95">
                    {/* Search Input */}
