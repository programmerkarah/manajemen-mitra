...
<body>
    <!-- MAIN SPK DOCUMENT -->
    <div class="header">
        <h3 style=" font-weight: bold; font-style: italic;">PERJANJIAN KERJA</h3>
        <h3 style=" font-weight: bold; font-style: italic;">PETUGAS LAPANGAN KEGIATAN {{ strtoupper($kegiatan->nama_kegiatan) }} TAHUN {{ $kegiatan->tahun_anggaran }}</h3>
        <h3 style=" font-weight: bold; font-style: italic;">PADA BADAN PUSAT STATISTIK KOTA SAWAHLUNTO</h3>
