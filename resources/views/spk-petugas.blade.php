...
<body>
    <!-- MAIN SPK DOCUMENT -->
    <div class="header">
        <h3 style=" font-weight: bold;">PERJANJIAN KERJA</h3>
        <h3 style=" font-weight: bold;">PETUGAS LAPANGAN KEGIATAN {{ strtoupper($kegiatan->nama_kegiatan) }} TAHUN {{ $kegiatan->tahun_anggaran }}</h3>
        <h3 style=" font-weight: bold;">PADA BADAN PUSAT STATISTIK KOTA SAWAHLUNTO</h3>
    ...
    <div class="pasal">
        ...
        <div class="pasal-content">
            Jangka Waktu Perjanjian terhitung sejak Perjanjian ditandatangani sampai dengan tanggal {{ \Carbon\Carbon::create($periode->tahun, $periode->bulan, 1)->endOfMonth()->format('d') }} {{ \Carbon\Carbon::create($periode->tahun, $periode->bulan, 1)->endOfMonth()->locale('id')->translatedFormat('F Y') }}.
        </div>
    </div>
