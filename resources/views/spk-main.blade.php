...
<head>
    ...
    <title>SPK {{ $nomorSpk }} {{ $kegiatan->nama_kegiatan }} - {{ $petugas->nama }}</title>
    <style>
        @page {
            size: A4;
    ...
    <div class="pasal">
        ...
        <div class="pasal-remaining-items">
            <div class="pasal-item">
                <div class="pasal-item-number">(2)</div>
                <div class="pasal-item-content">
                    Apabila terjadi kerusakan perangkat pencacahan yang menyebabkan pelaksanaan pencacahan lapangan {{ $kegiatan->nama_kegiatan }} pada Badan Pusat Statistik Kota Sawahlunto tidak dapat dilakukan, <strong>PIHAK KEDUA</strong> melalui Tim Teknis BPS Kota Sawahlunto memberitahukan kepada <strong>PIHAK PERTAMA</strong> dalam waktu paling lambat 14 (empat belas) hari kalender sejak terjadi kerusakan dimaksud.
                </div>
            </div>
            <div class="pasal-item">
                <div class="pasal-item-number">(3)</div>
