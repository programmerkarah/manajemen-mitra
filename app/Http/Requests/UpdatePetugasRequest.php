...
class UpdatePetugasRequest extends FormRequest
{
    ...
    {
        // Route parameter is 'petuga' (singular form generated by Laravel)
        $petugasHash = $this->route('petuga');
        $petugasId = null;

        if ($petugasHash) {
            $petugasId = \Vinkla\Hashids\Facades\Hashids::decode($petugasHash)[0] ?? null;
        }
