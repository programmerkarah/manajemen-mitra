...
class UpdatePetugasRequest extends FormRequest
{
    ...
    {
        // Get the petugas ID from route parameter
        $petugasHash = $this->route('petugas');
        $petugasId = null;
        ...
        return [
            ...
            'nik' => ['required', 'string', 'size:16', Rule::unique('petugas', 'nik')->ignore($petugasId)],
            ...
            'npwp' => ['nullable', 'string', 'size:15', Rule::unique('petugas', 'npwp')->ignore($petugasId)->whereNotNull('npwp')],
