...
class PeriodeAlokasi extends Model
{
    ...
    protected $casts = [
        ...
        'jadwal_pengolahan_listing_mulai' => 'date',
        'jadwal_pengolahan_listing_selesai' => 'date',
        'jadwal_pengolahan_pencacahan_mulai' => 'date',
        'jadwal_pengolahan_pencacahan_selesai' => 'date',
